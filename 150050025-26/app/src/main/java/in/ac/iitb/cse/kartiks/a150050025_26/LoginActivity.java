...
//        SharedPreferences sh = getSharedPreferences("home", Context.MODE_PRIVATE);
//        if(sh.getBoolean("auth", false)){
//            Intent intent = new Intent(getApplicationContext(), HomeActivity.class);
//            String restoredId = sh.getString("id","");
//            intent.putExtra("id",restoredId);
...
//        }
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password) && !isUserValid(email, password)) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                String param = "id="+mEmail+"&password="+mPassword;
